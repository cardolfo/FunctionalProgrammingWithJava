...
public class Chapter3Challenge1 {
    public static void main(String[] args) {
        ...
        Function<Person, String> extractName = (person) -> person.name;

        List<String> namesOfPeoples = people.
                stream().
                map(extractName).
                collect(Collectors.toList());

        System.out.println(namesOfPeoples);
        ...
        Predicate<Car> filterBlueCars = (car) -> Objects.equals(car.color, "blue");

        List<String> nameOfBlueCars =  cars
                .stream()
                .filter(filterBlueCars)
                .map(car -> car.make)
                .collect(Collectors.toList());

        System.out.println(nameOfBlueCars);
        ...
        BinaryOperator<Float> sumAllSalaries = Float::sum;

        Float sumOfAllSalaries = employees
                .stream()
                .map((employee -> employee.salary ))
                .reduce(0f, sumAllSalaries);
